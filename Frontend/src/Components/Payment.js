...
import tk from './assests/ticket.jpg';
function msg(){
...
function Payment() {
  ...
  const handelDownload=()=>{
    ...
    return ( 
        <>
        <div class="wrapper1" style={{marginTop:"0px"}}>
    {/* <div class="wrapper"> */}
      ...
      <div class="payment" >
        ...
        <div class="form">
          ...
          <div class="card space icon-relative">
            ...
            <input type="text"  value={bank} onChange={(e) => setBank(e.target.value)} class="input" ></input>
            {errors.bank && <span className="error-message">{errors.bank}</span>}
            {/* <i class="fas fa-user"></i> */}
          </div>
          <div class="card space icon-relative">
            <label class="label">Card number:</label>
            <input type="text"  value={card} onChange={(e) => setCard(e.target.value)} class="input" data-mask="0000 0000 0000 0000" placeholder="Card Number"></input>
          ...
          <div class="card-grp space">
            <div class="card-item icon-relative">
              ...
              <input type="text" value={exdate} onChange={(e) => setExdate(e.target.value)} name="expiry-data" class="input" data-mask="00 / 00"  placeholder="00 / 00"></input>
              {errors.exdate && <span className="error-message">{errors.exdate}</span>}
              {/* <i class="far fa-calendar-alt"></i> */}
            </div>
            <div class="card-item icon-relative">
              <label class="label">CVC:</label>
              <input type="text" value={cvv} onChange={(e) => setCvv(e.target.value)} class="input" data-mask="000" placeholder="000"></input>
